...
# Ако искате да я тествате затворете приложението и го отворете отново.
...
# 1. Да работи Spinbox, да не е през терминала.
# 2. Да не презаписва файла, а да добавя автоматично милилитрите + да ги пресмята.
# 3. Да импортнем дата и да знае автоматично кой ден е.
# 4. Chart - да добавя за всеки ден.